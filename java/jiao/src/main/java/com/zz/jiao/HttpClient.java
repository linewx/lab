...
public class HttpClient {
	 ...
	 */
	public static String getRs(String path, String params, String reqencoding,
			String respencoding, String requestMethod,Integer httpConnectTimeout,Integer httpReadTimeout,Map<String, String> headerMap,String cookies,Proxy proxy,String proxyUser,String proxyPwd) {
