 ...
 * wushujia
 */
public class ClientBaff {
	private String server = "http://127.0.0.1:8083" ; // http://yz.geotmt.com、https://yz.geotmt.com
	private int encrypted = 0 ; // 是否加密传输
	...
	private String username = "xinghongqian1" ; // 账户向GEO申请开通
	private String password = "123456" ;
	private String uno = "200417" ;
	...
	public static void main(String[] args){
		ClientBaff client = new ClientBaff();
		String path = client.server+"/civp/getview/api/u/baffLeInterFace/queryUnify" ;
		Map<String,String> params = new HashMap<String,String>();
		params.put("innerIfType", "INDC501000") ;
		params.put("cid", "13300001000") ;
		params.put("idNumber", "440281200608083316") ;
		params.put("cardNo", "6227000310460046666") ;
		//params.put("asynAddress", "http://124.42.101.71:8083/civp/getview/web/o/zyxaDataApi");
