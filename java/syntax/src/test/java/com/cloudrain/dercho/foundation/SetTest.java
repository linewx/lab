...
public class SetTest {
    private HashSet<String> fixture;

    @Before
    public void setup() {
        fixture = new HashSet<>(Arrays.asList("java", "javascript", "python", "c++", "bash", "javascript"));
    }
    ...
    public void addTest() {
        ...
        Assert.assertFalse(fixture.add("java"));
    }
...
//    }
    ...
    public void toArrayTest() {
        ...
        Assert.assertEquals(strArrays.length, 5);
    }
